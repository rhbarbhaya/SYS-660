...
range_sheet = pd.read_csv("RangeSheet.csv")
...
while len(Year0) <= 138023:
	RangeForYear0()
print ("Year 0 - Done!")

while len(Year1) <= 138023:
	RangeForYear1()
print ("Year 1 - Done!")

while len(Year2) <= 138023:
	RangeForYear2()
print ("Year 2 - Done!")

while len(Year3) <= 138023:
	RangeForYear3()
print ("Year 3 - Done!")

while len(Year4) <= 138023:
	RangeForYear4()
print ("Year 4 - Done!")

while len(Year5) <= 138023:
	RangeForYear5()
print ("Year 5 - Done!")

while len(Year6) <= 138023:
	RangeForYear6()
print ("Year 6 - Done!")

while len(Year7) <= 138023:
	RangeForYear7()
print ("Year 7 - Done!")

while len(Year8) <= 138023:
	RangeForYear8()
print ("Year 8 - Done!")

while len(Year9) <= 138023:
	RangeForYear9()
print ("Year 9 - Done!")

while len(Year10) <= 138023:
	RangeForYear10()
print ("Year 10 - Done!")

while len(Year11) <= 138023:
	RangeForYear11()
print ("Year 11 - Done!")

while len(Year12) <= 138023:
	RangeForYear12()
print ("Year 12 - Done!")

rows = zip(Year0, Year1, Year2, Year3, Year4, Year5, Year6, Year7, Year8, Year9, Year10, Year11, Year12)
with open("RangeAssign.csv", "w") as f:
